...
class LPIPSWithDiscriminator(nn.Module):
    def __init__(self, *, disc_start, logvar_init=0.0, kl_weight=1.0, pixelloss_weight=1.0,
        ...
        # Avoid downloading ImageNet VGG during inference when perceptual loss
        # is disabled (the RadioDiff sampling config sets its weight to zero).
        self.perceptual_loss = LPIPS().eval() if perceptual_weight > 0 else nn.Identity()
